...
const router = require('../ping-cache');

const apiMethod = 'GET';
const apiPath = '/api/accounts/v1/status/ping-cache';
...
describe(apiPath, () => {
  ...
  it('should return a JSON when sending para, "cacheInSeconds"', async () => {
    ctx.database.models.sequelize.authenticate = sinon.stub().returns(undefined);
    ctx.params.cacheInSeconds = 20;
